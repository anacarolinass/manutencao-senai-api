...
public class TecnicoService {
	...
	public Tecnico inserir(@Valid @NotNull(message = "O técnico não pode ser nulo") 
		Tecnico novoTecnico) {
	...
	public Tecnico alterar(@Valid 
			@NotNull(message = "O tecnico não pode ser nulo") 
		Tecnico tecnicoSalvo) {

		Preconditions.checkArgument(!tecnicoSalvo.isNovo(), "O tecnico ainda não foi inserido");
	...
	public List<Tecnico> listarPor(
			@NotEmpty(message = "O nome para a busca não pode ser nulo") 
